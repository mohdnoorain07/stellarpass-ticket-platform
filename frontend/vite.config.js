    ...
    plugins: __spreadArray([
        ...
        VitePWA({
            ...
            manifest: {
                ...
                description: 'Create events, mint verifiable tickets, transfer ownership, verify attendance with QR codes, and settle secondary market royalties on-chain with Soroban smart contracts.',
                theme_color: '#0f1115',
